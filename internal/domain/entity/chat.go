...
type ChatConfig struct {
	Model 				*Model
	Temperature			float32		// 0.0 a 1.0 - criatividade nas respostas
	TopP				float32		// 0.0 a 1.0 - sensibilidade nas respostas
	N					int			// numero de msgs a retornadas
	Stop				[]string	// string para parar o chat
	MaxTokens			int			// maximo de numero de tokens em uma conversa
	PresencePenalty		float32		// -2.0 a 2.0 - penalidade pelo uso de palavras repetidas
	FrequencyPenalty	float32		// -.20 a 2.0 - penalidade pelo uso de palavras repetidas
}
